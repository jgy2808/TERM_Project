...
<body>
	<div class="d-flex justify-content-between align-items-center"
		...
		<a onClick="history.back()"><i class="fa fa-chevron-left" 
			style="width: 30px; height: 30px; font-size: 24px; color: rgb(255, 255, 255);"></i></a><label
			class="form-label"
	...
	<h1 style="padding-left: 5px;border-left-style: solid;border-left-color: rgb(142,142,142);width: 80%;max-width: 400px;margin: 15px;">회원가입</h1>
		...
		<input type="text" placeholder="이름" name="name"
			style="width: 80%; max-width: 400px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-bottom-color: rgb(0, 0, 0); border-left-style: none;">
		<div style="width: 80%; max-width: 400px;">
			<label class="form-label" style="margin: 0px; margin-top: 15px;">아이디</label>
			<div class="d-flex justify-content-between align-items-center"
				style="max-width: 400px;">
				<input type="text" placeholder="아이디" id="id_id" name="id"
					style="max-width: 400px; width: 60%; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-bottom-color: rgb(0, 0, 0); border-left-style: none;">
				<button class="btn btn-primary" id="idcheck" type="button"
					style="background: rgb(92, 198, 186);">중복 확인</button>
			</div>
		...
		<input type="password" placeholder="비밀번호 확인" name="pw_check"
			style="width: 80%; max-width: 400px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-bottom-color: rgb(0, 0, 0); border-left-style: none;">
		...
		<input type="text" placeholder="지역" name="area"
			style="width: 80%; max-width: 400px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-bottom-color: rgb(0, 0, 0); border-left-style: none;">

		<button class="btn btn-primary" id="submit" type="button"
			style="margin-top: 20px; width: 80%; max-width: 400px; background: rgb(92, 198, 186);">완료</button>
